...
(function () {
  ...
  function goBackToSession() {
    const os = localStorage.getItem('rae-os');
    const screen = os === 'macos' ? 'mac.html' : 'windows.html';
    // Only carry a pinned variant: appending the default would also switch on
    // the dev variant chip on the way back.
